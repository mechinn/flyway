...
/**
 * Test for TeradataSQLSqlStatementBuilder.
 */
@Category(DbCategory.Teradata.class)
public class TeradataSqlStatementBuilderSmallTest {
    /**
     * Class under test.
     */
    private TeradataSqlStatementBuilder statementBuilder = new TeradataSqlStatementBuilder();
    ...
    public void blobLiteral() throws Exception {
        statementBuilder.addLine("INSERT INTO test_table (id, bin) VALUES(1, '01'XC);");
        assertTrue(statementBuilder.isTerminated());
    }
}
